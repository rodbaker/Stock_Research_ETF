...
# -*- coding: utf-8 -*-
#
# ETF_Analysis documentation build configuration file, created by
# sphinx-quickstart.
#
...
htmlhelp_basename = 'R_Baker_Stock_Researchdoc'
...
texinfo_documents = [
    ('index', 'R_Baker_Stock_Research', u'ETF_Analysis Documentation',
     u"R Baker", 'ETF_Analysis',
     'Analysis of various ETF's', 'Miscellaneous'),
]
